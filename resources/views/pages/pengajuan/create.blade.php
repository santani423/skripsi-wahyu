            ...
            <div class="card mb-3">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('pengajuan.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <!-- Tambahan form upload slip gaji -->
                        <div class="mb-3">
                            <label for="file_slip_gaji" class="form-label">Upload Slip Gaji</label>
                            <input type="file" class="form-control @error('file_slip_gaji') is-invalid @enderror" id="file_slip_gaji" name="file_slip_gaji" required>
                            @error('file_slip_gaji')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>

                        <!-- Tambahan form upload rekening koran -->
                        <div class="mb-3">
                            <label for="file_rekening_korang" class="form-label">Upload Rekening Koran</label>
                            <input type="file" class="form-control @error('file_rekening_korang') is-invalid @enderror" id="file_rekening_korang" name="file_rekening_korang" required>
                            @error('file_rekening_korang')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
